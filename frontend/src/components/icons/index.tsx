...
export const LogoIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2a4.5 4.5 0 0 0-4.5 4.5c0 .8.2 1.6.6 2.3A4.5 4.5 0 0 0 4 13.5a4.5 4.5 0 0 0 4.5 4.5c.3 0 .7 0 1-.1A4.5 4.5 0 0 0 14 22a4.5 4.5 0 0 0 4.5-4.5c0-.8-.2-1.6-.6-2.3A4.5 4.5 0 0 0 22 10.5 4.5 4.5 0 0 0 17.5 6c-.3 0-.7 0-1 .1A4.5 4.5 0 0 0 12 2Z" />
    <path d="M12 12v.01" />
  </svg>
);
...
export const EyeOffIcon: React.FC<IconProps> = ({ className = 'w-4 h-4' }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M9.88 5.09A10.94 10.94 0 0 1 12 5c6.5 0 10 7 10 7a18.88 18.88 0 0 1-3.56 5.03" />
    <path d="M6.61 6.61A18.72 18.72 0 0 0 2 12s3.5 7 10 7a10.73 10.73 0 0 0 5.39-1.61" />
  </svg>
);